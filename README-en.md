> 🇻🇳 **Người Việt: xem [README.md](README.md)** — bản dịch tiếng Việt (mặc định của repo này).
> 🇬🇧 This is the upstream English README from `eugeniughelbur/obsidian-second-brain`, kept here for reference. The default README of `ces-second-brain` is in Vietnamese.
