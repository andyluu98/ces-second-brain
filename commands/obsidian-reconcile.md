---
description: Tìm và giải quyết mâu thuẫn trong vault — vault tự duy trì sự thật của nó
---

Use the ces-second-brain skill. Execute `/obsidian-reconcile $ARGUMENTS`:
