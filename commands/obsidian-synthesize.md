---
description: Tổng hợp tự động — quét vault tìm pattern chưa đặt tên và viết trang tổng hợp mà không cần nhờ
---

Use the ces-second-brain skill. Execute `/obsidian-synthesize`:
