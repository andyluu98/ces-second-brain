---
description: Đọc sâu post X (Twitter) qua Grok + Live Search — post nguyên văn, thread, TL;DR, luận điểm, sentiment phản hồi, voices đáng theo dõi
---

Use the ces-second-brain skill. Execute `/x-read [url]`:
